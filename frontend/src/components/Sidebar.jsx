...
const Sidebar = () => {
    ...
    return (
        <motion.div 
            ...
            className="d-flex flex-column flex-shrink-0 p-4 bg-background border-end border-secondary border-opacity-10 h-100" 
        ...
        >
            <div className="d-flex align-items-center mb-5 ps-2">
                ...
                <div>
                    <h5 className="fw-bold mb-0 text-white tracking-tighter">Maintain<span className="text-primary text-opacity-70">OS</span></h5>
                ...
                {links.map((link, i) => (
                    ...
                    >
                        ...
                        >
                            ...
                            {({ isActive }) => isActive && <motion.div layoutId="activeInd" className="bg-primary rounded-pill me-n2" style={{ width: '3px', height: '16px' }} />}
                        </NavLink>
                    </motion.li>
                ))}
            </ul>
            ...
            <div className="mt-auto">
                <div className="premium-card p-3 border-secondary border-opacity-10 bg-surface bg-opacity-40 mb-3">
                    <div className="d-flex align-items-center mb-3">
                        <div className="p-2 rounded-circle bg-background text-primary me-2 border border-secondary border-opacity-10">
                            <UserCircle size={18} />
                        </div>
                        <div className="overflow-hidden">
                            <h6 className="fw-bold mb-0 smaller text-white text-truncate">{user?.name}</h6>
                ...
                <div className="text-center">
                    <p className="smaller text-muted opacity-30 mb-0">Platform v2.8.0-Dark</p>
                </div>
            </div>
        </motion.div>
    );
