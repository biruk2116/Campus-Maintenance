...
const PublicFooter = () => {
    ...
    return (
        <footer className="bg-slate-300 dark:bg-slate-900 pt-20 pb-10 px-6 border-t border-slate-400 dark:border-slate-700 relative z-10 text-gray-700 dark:text-slate-400">
