...
const Contacts = () => {
    return (
        <PublicLayout>
            <section className="mt-[65px] py-12 px-6 relative bg-gray-50 dark:bg-slate-900 min-h-[calc(100vh-65px)]">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600 dark:text-slate-400 text-base max-w-2xl mx-auto">
                            Get in touch with the Debre Berhan University maintenance office.
                        </p>
                    </div>
