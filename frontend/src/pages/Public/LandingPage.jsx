                                ...
                                <div className="row g-3 hero-metrics">
                                    {heroMetrics.map((item) => (
                                        <div className="col-sm-4" key={item.label}>
                                            <motion.div whileHover={{ y: -6 }} className="hero-metric-card">
                                ...
                                {[
                                    ...
                                    <motion.div key={i} whileHover={{ x: 10 }} className="premium-card p-4 d-flex align-items-center bg-surface border-secondary border-opacity-10 shadow-sm flex-grow-1">
                                        ...
                                        <div>
                                            ...
                                            <p className="smallest text-muted mb-0">{item.desc}</p>
                                        </div>
                                    </motion.div>
                                ))}
                            </div>
                    ...
                    <div className="row g-5">
                        ...
                        <div className="col-md-4 col-lg-2">
                            ...
                            <ul className="list-unstyled d-flex flex-column gap-3">
                                {sectionLinks.map((item) => (
                                    <li key={item.id}>
                                        <button type="button" className="btn btn-link p-0 smaller text-muted text-decoration-none hover-primary transition-all d-flex align-items-center" onClick={() => handleNav(item.id)}>
                        ...
                        <div className="col-md-4 col-lg-3">
                            ...
                            <ul className="list-unstyled d-flex flex-column gap-3">
                                {[
                                    ...
                                    <li key={i}>
                                        <button type="button" className="btn btn-link p-0 smaller text-muted text-decoration-none hover-primary transition-all d-flex align-items-center text-start" onClick={() => handleNav(suite.anchor)}>
